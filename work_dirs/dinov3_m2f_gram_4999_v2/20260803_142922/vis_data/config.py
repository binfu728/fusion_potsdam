...
model = dict(
    backbone=dict(
        arch='vit_large',
        checkpoint=
        '/mnt/qh2-nas3/00-model/00-wrs/zhejiang_earth_results/zhejiang_DinoViT_large_Olmoearth10m_128gpu_stage2_stage3_no_cl_gram_nofusion/4999_new.pt',
        finetune_vit=False,
...
work_dir = 'work_dirs/dinov3_m2f_gram_4999_v2'
