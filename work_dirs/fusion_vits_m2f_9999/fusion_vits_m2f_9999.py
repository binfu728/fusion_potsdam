...
FUSION_CKPT = '/mnt/qh2-nas3/00-model/00-limx/Dinov3/ckpt/stage2+stage3-zhejiang/9999.pth'
...
model = dict(
    backbone=dict(
        arch='vit_large',
        checkpoint=
        '/mnt/qh2-nas3/00-model/00-limx/Dinov3/ckpt/stage2+stage3-zhejiang/9999.pth',
        finetune_vit=False,
...
work_dir = 'work_dirs/fusion_vits_m2f_9999'
