...
DINO_CKPT = '/mnt/ht2_nas2/EO_test/weights/Dinov3_pretrained/DINOv3_ViT_SAT-493M/dinov3_vitl16_pretrain_sat493m-eadcf0ff.pth'
...
model = dict(
    backbone=dict(
        arch='vit_large',
        checkpoint=
        '/mnt/ht2_nas2/EO_test/weights/Dinov3_pretrained/DINOv3_ViT_SAT-493M/dinov3_vitl16_pretrain_sat493m-eadcf0ff.pth',
        finetune_vit=False,
...
work_dir = 'work_dirs/dinov3_m2f_sat'
